                ...
                <div v-if="goods.showCate.type =='紧固件'">
                  ...
                  <div class="name_info2"
                    ...
                    <span v-for="(items,i) in item.showCategoryList" :key="i"
                      ...
                      {{items.name}}<img v-if="showImg ===items.img && items.img" class="item_img"
        ...
        <div class="Navigation" id="Navigation">
          <ul class="Navigation_name" style="width: 1000px">
            <li class="sli" @click="navalist.isnew==1?selected2(index):selected(index)"
                :class="{'active':'index-'+navalist.nalink==$store.state.titleStoreinfo&&$route.name!='index'}"
                v-for="(navalist,index) in navalists" :key="index">
              {{navalist.natitle}}
            </li>
          </ul>
        </div>
        <div class="banner_login" v-if="$store.state.loginInfo!==undefined"
...
//        let SearchURL="search";
        if (this.navalists[index].nalink == 'CheckStand') {
          ...
          else if(this.navalists[index].nalink==='IndustrialProducts/search'||this.navalists[index].nalink==='LifeQuality/search'||this.navalists[index].nalink==='IndustrialQuality/search'){
            this.$router.push({path:'/'+this.navalists[index].nalink});
          }
          else
...
//        let SearchURL="search";
        if (this.navalists[index].nalink == 'CheckStand') {
          ...
          if (this.navalists[index].nalink === '/')
            ...
            Iurl='/'+this.navalists[index].nalink;

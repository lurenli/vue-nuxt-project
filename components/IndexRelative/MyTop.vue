  ...
  <div class="MyTop" id="MyTop">
    <div class="top">
      <div class="top_left">
        ...
        <span class="loginAfter" v-if="loginInfo!==undefined">
        ...
        <span class="loginBefore" v-else>
              <a @click="goToLogin" class="login">请登录</a>
              <a @click="goToSignUp" class="regis">请注册</a>
        </span>
        <span class="choose-address">
             <my-address/><i class="icon down"></i>
          </span>
      ...
      <div class="top_right">
        <ul>
          ...
          <li>
            <div>
              <span style="cursor: pointer">&nbsp;客服中心&nbsp;&nbsp;&nbsp;</span><i class="icon down"></i>
        ...
        if (this.$store.state.loginInfo === undefined) {
          ...
          vue.$http.post(
            ...
            function (vue, data) {
              ...
              vue.$store.commit("newNum", 1);//update
              vue.loginInfo = vue.$store.state.loginInfo;

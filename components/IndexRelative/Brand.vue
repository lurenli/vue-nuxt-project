    ...
    <div class="MyBrand">
      <div class="MyBrand2" >
        <div class="container-wrap" v-if="contentWarp">
          ...
          <div class="list_wrap" :style="{left:leftSize + 'px'}" v-on:mouseenter="fadeIn" v-on:mouseleave="fadeOut">
            <li v-for="(item,index) in activeList" :key="index" @click="jumpDetail(item.id,item.limitid,item.producttype)">
      ...
      <div class="active_banner" v-if="show">
        <a :href="URL" target="_blank" style="display: block">
          <img :src="$oss.publicUrl(imgs)" :height="heights" width="1200px" style="cursor: pointer"/>
        </a>
        ...
        vue.$http.post(
          ...
          function (vue, data) {
            if(data.data==null){
              ...
              vue.heights=data.height;
              vue.widths=data.width;

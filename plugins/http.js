...
if(process.env.NODE_ENV==='development'){
  axios.defaults.baseURL = config.app.http.baseUrl4Test;
}else{
  // 针对 渲染
  if(process.env.PORT==='12031'){
    axios.defaults.baseURL = "http://47.98.222.182/jinshang-server";
  }else if(process.env.PORT==='12030'){
    axios.defaults.baseURL = "http://120.27.226.95/jinshang-server";
  }
  if(process.browser){
    axios.defaults.baseURL = "http://"+window.location.hostname+"/jinshang-server";
  }
...
// 服务端渲染的
function post4s(ret,url, params) {

  ...
  <div class="wrap">
    ...
    <div class="signUp">
      ...
      <div class="item-a">
        ...
        <span class="a-right" @click="changeImage"><a>看不清楚，换一张？</a></span>
      </div>
      <div class="item-a">
        ...
        <button class="get-check" value="获取短信验证码" @click="getMobileCode" :disabled="sendMsg">
      ...
      <div class="item-a item-d">
        <span class="a-left"></span>
        <button class="sign-up-x" @click="SignUp">立即注册</button>
      </div>
    </div>
    <div style="height: 60px"></div>
  </div>
...
//            }
//              vue.$router.push({name: 'SignUp-SignUpx'});
              window.open('/SignUp/SignUpx','_self');

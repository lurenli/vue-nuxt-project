  ...
  <div class="forget-main">
    ...
    <div class="signUp">
      ...
      <div  class="item-a">
        ...
        <span class="a-right" @click="changeImage"><a style="cursor: pointer">看不清楚，换一张？</a></span>
      </div>
      <div  class="item-a">
      ...
      <div  class="item-a item-d">
        ...
        <button class="sign-up" @click="goTo2">下一步</button>
      </div>
    </div>
  </div>
  </div>
...
//              console.log(data);
              ...
              if(data.result ==1){
                vue.$router.push({ path: '/SignUp/forget2' });
              }
            },function (error,data) {
              // 错误处理
//              console.log(data);

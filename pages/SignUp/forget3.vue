<template>
  ...
  <div class="forget-main">
    ...
    <div class="signUp">
      ...
      <div class="right-a">
        <span class="red">新密码设置成功！</span>
        <span>新密码设置成功.<span class="left-20" @click="mmLogin">返回登录</span></span>
      </div>
    </div>
    <!--</form>-->
  </div>
...
<style scoped>
  ...
  .duigou{
    ...
    width: 46px;
    height: 46px;
    background: url(../../assets/login/image/duigou.png) no-repeat left top;
  }
  .red{
    font-size: 16px;
    margin-bottom: 20px;
  ...
  .right-a>span:first-child{
    display: block;
  }
  .right-a>span:last-child{
    font-size: 14px;

       ...
       <div class="content">
          <div class="top_left">
            <ul class="topBar">
              ...
              <li v-for="(msg,index) in topBar" :key="index"
                  @click="showContent(msg.id);selected(index)"  :class="{active: activeName == index}">
                <a :href="'/CheckStand/'+msg.id"></a>
         ...
         <div class="top_mid">
              <ul class="show_ul" v-show="showType==0">
                <li v-for="(son,index) in showMsg" :key="index" @click="standDetail(son.id)">
...
<script>
  ...
  import MyTop from "../components/IndexRelative/MyTop.vue";
  export default{
    components: {
      MyTop,MyFooter
    },

        ...
        <div class="keywords_content">
          ...
          <div class="keywords_content2">
            <table class="keywords_content_tbd2" style="width: 100%; border-color: #d9d9d9">
              ...
              <tbody>
              <tr v-for="(getInformation,index) in getInformations" :key="index" class="getInformation2s">
                ...
                <td>
                  <select class="num_danwei" v-model="getInformation.selected" v-if="getInformation.producttype==1"
                          ...
                          :data-pdid="getInformation.pdid" :data-storeid="getInformation.storeid"
                          :data-delivertime="getInformation.delivertime">
                    <option v-for="(item,i) in getInformation.packages" :key="i" class="danwei">{{ item.unit }}</option>
                  </select>
...
//        console.log('跳转')
        if (type == 1) {
          this.$router.push({name: "index-IndustrialDetail-id", params: {id: id}});
        } else if (type == 2) {
          this.$router.push({name: "index-FastDetail-id", params: {id: id}});
        }

    ...
    <div class="PayYinlian">
        <div class="PayYinlian_content">
          <div class="PayYinlian_content_one">
            <p class="PayYinlian_title" @click="addMood">＋添加新的银行卡</p>
            <div class="PayYinlian_card" v-for="(PayYinlian_card,i) in PayYinlian_cards" :key="i">
            ...
            <div class="next_pay" @click="addMood2">下一步</div>
            <div v-if="addBank" class="bg-mood">
              <div class="addBankInfo">
                ...
                <div class="button-wrap"><button class="add-btn add-btn-style" @click="qxAdd">确定</button><button class="qx-btn add-btn-style" @click="qxAdd">取消</button></div>
              </div>
            </div>
          </div>
        </div>
      <div class="popup_box" v-if="addSure">
        <div class="popup">
          ...
          <div class="btn_group">
            <div class="save_btn2" @click="jump('ShopCar-PaySuccess')">确认</div>

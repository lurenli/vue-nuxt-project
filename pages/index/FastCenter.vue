  ...
  <div class="FastCenter">
    ...
    <div class="helpSide">
      <div class="sideBar">
        ...
        <ul>
          <li v-for="(msg,index) in sideDatas" :key="index" >
            <a style="cursor: pointer" :class="{active: $route.fullPath == '/FastCenter/alerts/'+msg.id}"
               :href="'/FastCenter/alerts/'+msg.id">
              {{msg.docname}}
            </a>
          </li>
        </ul>
  ...
  export default {
    ...
    methods: {
      ...
      jump: function (data) {
        ...
        this.$router.replace({name: 'index-FastCenter-alerts-docid', params: {docid: data.id}})
      },
//        加载侧边栏---文章所有分类
//       classRequest: async function () {
//         let vue = this;
//         let param = {
//           docName: "资讯中心"
//         };
//         await vue.$http.apost(

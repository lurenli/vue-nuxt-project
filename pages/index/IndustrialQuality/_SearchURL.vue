      ...
      getList: function () {
        ...
        vue.$http.post(
          ...
          function (vue, data) {
            // 成功处理
//              处理搜索列表数据
            localStorage.removeItem('FsearchKey2');
...
//      点击分页--自营 价格等排序直接生成url
      getUrl:function(){
        ...
        if(this.searchkeys.length>0){
         ...
         SearchURL="/IndustrialQuality/search"+this.getparam+"?"+this.getquery;
        }else{
          SearchURL="/IndustrialQuality/search"+this.getparam;
        }
...
//            //转译标签中的'#'
        ...
        SearchURL = "/IndustrialQuality/search" + getparam2 + "?" + getquery2 ;
      }else{
        SearchURL = "/IndustrialQuality/search" + getparam2;
      }
...
//            //转译标签中的'#'
      ...
      SearchURL = "/IndustrialQuality/search" + myparam + "?" + myquery ;
    }else{
      SearchURL = "/IndustrialQuality/search" + myparam;
    }
    return SearchURL;
  }
</script>

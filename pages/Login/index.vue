    ...
    <div id="login_form" class="login_box">
      <div>
        ...
        <div class="auto_log">
          ...
          <div class="forget">
            <router-link  to="/SignUp/forget1">
              <a href="javascript:avoid();">忘记密码</a>
            </router-link>
        ...
        <button  class="loginButton" @click="loginFun">立即登录</button>
        <div class="log_bom">
...
<script>
  ...
  export default {
    ...
    methods:{
      keyLogin(ev) {
        if(ev.keyCode==13){
          if(this.loginInfo.username&&this.loginInfo.password&&this.loginInfo.yanzheng){
            this.loginFun();
          }
        }
      },
      //第三方登录
      qqLogin:function(){
        this.$router.push({ name:'Login-qqLogin' });
      },
      wxLogin:function(){
